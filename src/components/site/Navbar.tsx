    ...
    <>
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "group relative text-sm font-medium tracking-wide text-white/80 transition-colors",
                      "hover:text-white",
                      isActive && "text-white",
                    )}
                  >
      ...
      {open ? (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="relative mx-auto flex h-full max-w-md flex-col justify-between px-6 pb-10 pt-24">
